...
const SaveBody = z.object({
  ...
  pillarParams: z.record(z.string(), z.unknown()).optional(),
  pastedText: z.string().optional(),
  sourceFiles: z.array(z.object({ name: z.string(), sizeBytes: z.number() })).optional(),
...
export async function POST(req: Request) {
  ...
  const data: Prisma.ProjectUpdateInput = {
    ...
    pillarParams: (body.pillarParams ?? null) as unknown as Prisma.InputJsonValue,
    pastedText: body.pastedText ?? null,
    sourceFiles: (body.sourceFiles ?? null) as unknown as Prisma.InputJsonValue,
    profile: (body.profile ?? null) as unknown as Prisma.InputJsonValue,
